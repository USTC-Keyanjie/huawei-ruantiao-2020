...
void input_data()
{
    ...
    end_time = clock();
    if (record_time)
        cout << "输入 " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
}
...
void write_result()
{
    ...
    end_time = clock();
    if (record_time)
        cout << "输出 " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
}
...
vector<unordered_set<int>> strongly_connected_components(unordered_set<int> &nodes)
{
    ...
    end_time = clock();
    if (record_time)
        cout << "分割 " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
    return scc_results;
}
...
void dfs(int start_id, unordered_set<int> &cur_nodes)
{
    ...
    end_time = clock();
    if (record_time)
        cout << "搜索 " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s " << count_res << endl;
}
...
int main()
{
    ...
    end_time = clock();
    if (record_time)
        cout << "排序 " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
